...
public class JmsPutGet {
	...
	private static final String HOST = "104.197.9.45 "; // Host name or IP address
	private static final int PORT = 1414; // Listener port for your queue manager
	private static final String CHANNEL = "DEV.APP.SVRCONN"; // Channel name
	private static final String QMGR = "Q1"; // Queue manager name
	private static final String MQ_APP_USER = "app"; // User name that application uses to connect to MQ
	private static final String MQ_APP_PASSWORD = "8ATf5a3e4LP8aC6D5f39A8wHpJmm85knh"; // Password that the application uses to connect to MQ
	...
	public static void main(String[] args) {
		...
		try {
			...
			long uniqueNumber = System.currentTimeMillis() % 10;
			long uniqueNumber1 = System.currentTimeMillis() % 1000;
			
			TextMessage message1 = context.createTextMessage("Transaction:" + uniqueNumber1);
			TextMessage message = context.createTextMessage("Swift: FMBZBWGA" + uniqueNumber);
